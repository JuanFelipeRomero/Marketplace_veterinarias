...
export default function UserRegister(){
    ...
    return(
        ...
        <main className= "h-screen w-full flex login-bg">
            ...
            <Link to="/" className='self-start mb-4 ml-4' >
                ...
                <h2 className="md:text-[30px] text-black font-semibold text-center mb-6">Ingresa tu información personal</h2>
                    <Card.Root maxW='lg' bg='white' width="454px" shadow="0px 10px 15px -3px rgba(0, 0, 0, 0.10), 0px 4px 6px -2px rgba(0, 0, 0, 0.05)">
                        <Card.Body>
                            <Stack gap="16px" w="full">
                                ...
                                <Field label="Telefono" color='black'>
                                    <Input 
